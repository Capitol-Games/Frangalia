...
(function() {
  //=============================================================================
	...
	function InputHistory() {
		console.log('Initializing InputHistory')
	...
	InputHistory.prototype.initialize = function() {
		...
		console.log('Intialized empty button and swipe histories')
	};

	InputHistory.prototype.wasPressed = function(btn) {
		console.log('Checking wasPressed', btn)
		if (this._btnHistory.length < 1) return false;
		console.log('btnHistory', this._btnHistory)
		var pressed = false;
	...
	TouchInput.checkForDash = function() {
		$gameSystem.disableMenu()
		if (this._history.wasPressed('cancel')) {
			console.log('test')
		}
	}
	...
	TouchInput.isTouchingArea = function(rect) {
		console.log('Checking isTouchingArea', rect)
	...
	TouchInput.isClicked = function(rect) {
		console.log('Checking isClicked', rect)
	...
	TouchInput.addLastButton = function(btn) {
		console.log('Running addLastButton', btn)
  ...
  TouchInput.initialize = function() {
		console.log('Running TouchInput.initialize')
	...
	TouchInput._onTouchStart = function(event) {
		console.log('Running TouchInput._onTouchStart')
		// if ($dataMap) {
		// 	this.checkForDash()
		// }
		this.fingersDestroy();
	...
	TouchInput._onTouchMove = function(event) {
		console.log('Running TouchInput._onTouchMove')
	...
	TouchInput._onTouchEnd = function(event) {
		console.log('Running TouchInput._onTouchEnd')
		this.fingersDestroy();
